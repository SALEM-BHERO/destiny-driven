    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-slate-900 text-white py-24 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 opacity-50 z-0"></div>

          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 text-white">
                Destiny Driven <span className="text-amber-500">Finance</span>
              </h1>
              <h2 className="text-2xl md:text-3xl font-medium text-emerald-400 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center">
                <Link
                  to="/contact"
                  className="bg-amber-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-amber-700 transition-all duration-300 shadow-lg hover:shadow-amber-500/20 transform hover:-translate-y-1"
                >
                  Apply for a Loan
                </Link>
                <a
                  href="tel:0714635258"
                  className="border-2 border-emerald-500 text-emerald-400 px-8 py-4 rounded-xl font-bold hover:bg-emerald-500 hover:text-white transition-all duration-300"
                >
                  Call: 0714635258
                </a>
              </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">Our Loan Products</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Business Loans</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Salary Based Loans</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Asset Finance</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-green-100 group relative overflow-hidden">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Tobacco Farmers Loans</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">School Fees Loans</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Financial Advisory</h3>
                  <p className="text-gray-600 leading-relaxed">
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">Why Choose Destiny Driven Finance?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center p-6 border border-gray-100 rounded-2xl hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">Tailored Financial Services</h3>
              ...
              <div className="text-center p-6 border border-gray-100 rounded-2xl hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">Quick Turnaround</h3>
              ...
              <div className="text-center p-6 border border-gray-100 rounded-2xl hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">Expert Advice</h3>
        ...
        <section className="py-24 bg-slate-900 relative overflow-hidden">
          <div className="absolute inset-0 bg-emerald-900 opacity-20"></div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="inline-block bg-emerald-600 text-white px-10 py-4 rounded-full font-bold text-lg shadow-lg">
              Building Wealth For Generations
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center mb-12">
              <a
                href="tel:0714635258"
                className="bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-emerald-700 transition-all duration-300 flex items-center justify-center shadow-lg"
              >
              ...
              <Link
                to="/contact"
                className="bg-amber-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-amber-700 transition-all duration-300 shadow-lg"
              >
                Apply Now
              </Link>
            </div>

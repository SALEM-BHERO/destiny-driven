      ...
      <main className="flex-grow">
        ...
        <section className="bg-slate-800 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-orange-400 tracking-tight">About Destiny Driven Finance</h1>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="inline-block px-4 py-1 rounded-full bg-orange-100 text-orange-800 text-sm font-semibold mb-4">Our History</div>
                <h2 className="text-4xl font-bold text-slate-800 mb-6">Building Wealth, <br /><span className="text-green-600">One Client at a Time</span></h2>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-orange-400 shadow-sm">
                  <h3 className="font-bold text-slate-800 mb-2 text-lg">Head Office Address:</h3>
              ...
              <div className="bg-slate-800 rounded-2xl p-10 text-center text-white relative shadow-2xl transform hover:scale-105 transition-transform duration-300">
                <div className="absolute -top-6 -right-6 w-24 h-24 bg-orange-400 rounded-full flex items-center justify-center opacity-20"></div>
                <div className="w-24 h-24 bg-orange-400 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg rotate-3 hover:rotate-0 transition-all">
                ...
                <p className="text-green-400 font-bold tracking-wider mb-6">#TeamDestiny</p>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Vision */}
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-orange-400">
              ...
              {/* Mission */}
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-green-500">
                <div className="text-center mb-6">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <span className="text-green-600 font-bold tracking-wider uppercase text-sm">What We Stand For</span>
              <h2 className="text-4xl font-bold text-slate-800 mt-2 mb-4">Our Core Values</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="text-center group">
                <div className="w-20 h-20 bg-slate-50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-400 transition-colors duration-300">
                  <svg className="w-10 h-10 text-orange-400 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-slate-800 mb-3">Professionalism</h3>
              ...
              {/* Integrity */}
              <div className="text-center group">
                <div className="w-20 h-20 bg-slate-50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-green-600 transition-colors duration-300">
        ...
        <section className="py-20 bg-slate-800 relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
            <div className="absolute right-0 bottom-0 w-96 h-96 bg-green-500 rounded-full blur-3xl transform translate-x-1/2 translate-y-1/2"></div>
            <div className="absolute left-0 top-0 w-64 h-64 bg-orange-500 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="max-w-4xl mx-auto bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700">
                <p className="text-orange-400 font-bold text-3xl md:text-4xl mb-6">"Building Wealth For Generations"</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-slate-800 pt-12">
              <div className="text-center">
                <div className="text-5xl font-extrabold text-green-500 mb-2">5+</div>
                <div className="text-gray-400 font-medium">Branch Locations</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-extrabold text-orange-400 mb-2">1k+</div>
                <div className="text-gray-400 font-medium">Satisfied Clients</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-extrabold text-green-500 mb-2">8+</div>
                <div className="text-gray-400 font-medium">Financial Products</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-extrabold text-orange-400 mb-2">24/7</div>
        ...
        <section className="py-20 bg-blue-600 text-white relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="/contact"
                className="bg-white text-blue-800 px-10 py-4 rounded-xl font-bold hover:bg-blue-50 transition-colors duration-200 shadow-lg"
              >
                Get Started Today
              </a>
              <a
                href="/services"
                className="border-2 border-blue-300 text-white px-10 py-4 rounded-xl font-bold hover:bg-white/10 transition-colors duration-200"
              >
                View Our Services
              </a>
            </div>

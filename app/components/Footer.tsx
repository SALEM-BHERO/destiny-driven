        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-amber-500 text-sm font-medium">Building Wealth For Generations</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 text-emerald-400 bg-emerald-400/10 inline-block px-4 py-2 rounded-full">
              <span className="font-semibold">#TeamDestiny</span>
              <span className="text-emerald-400/50">|</span>
              <span className="text-emerald-300">Join thousands building their financial future</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/services" className="text-gray-400 hover:text-amber-500 transition-colors duration-200">
                  Our Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-center"><span className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-2"></span>Business Loans</li>
              <li className="flex items-center"><span className="w-1.5 h-1.5 bg-emerald-500 rounded-full mr-2"></span>Salary Based Loans</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              <h5 className="font-bold mb-4 text-white flex items-center">
                <svg className="w-5 h-5 mr-2 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                Head Office
              </h5>
            ...
            <div>
              ...
              <div className="text-gray-400 text-sm space-y-3 pl-7">
                <p className="flex items-center">
                  ...
                  <a href="tel:0714635258" className="hover:text-emerald-400 transition-colors">0714635258</a>
                </p>
                <p className="flex items-center">
                  <span className="w-20 text-gray-500">Email:</span>
                  <a href="mailto:destinydrivenf@gmail.com" className="hover:text-emerald-400 transition-colors">destinydrivenf@gmail.com</a>
                </p>
                <p className="flex items-center">
                  <span className="w-20 text-gray-500">WhatsApp:</span>
                  <a href="https://wa.me/263714635258" className="hover:text-emerald-400 transition-colors">0714635258</a>
                </p>
              </div>
            </div>

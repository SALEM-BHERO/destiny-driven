      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link 
              to="/contact" 
              className="bg-slate-800 text-white px-6 py-2 rounded-lg hover:bg-slate-900 transition-colors duration-200 font-medium"
            >
              Apply Now
            </Link>
          </div>
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <Link 
                  to="/contact" 
                  className="bg-slate-800 text-white px-6 py-3 rounded-lg hover:bg-slate-900 transition-colors duration-200 font-medium inline-block text-center w-full"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Apply Now
                </Link>
